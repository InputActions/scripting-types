...
import { CursorShape } from "./desktop/generic";
...
export interface InputBackend {
     ...
     */
    readonly virtualMouse: VirtualMouse;
}
...
export interface VirtualMouse {
    /**
     * @throws {Error} The configuration has not been activated yet ({@link Config.activated}).
     */
